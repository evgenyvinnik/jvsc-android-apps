...
public class Part
{
	...
	private int prec_start;
	private int prec_curtime;
	private boolean pplay;
	private int pplay_start;
	private int pplay_curtrigger;
	private int pplay_offset; // visualization
	private float pscrollx;
	private float pscrolly;
	private int scrollsize;
	
	private int edit_curtrigger;
	private boolean songplay;
	
	private int playing_note; // for graphical piano keyboard
	...
	public int msnum;
	public int[] msitriggers = new int [512];
	public Trigger[] mstriggers = new Trigger[512];
	public int mst1;
	public int msn1;
	public boolean ctrl_move;
	public int slide_origin;

	public boolean sbox_active;
	public int sbox_x1, sbox_y1, sbox_x2, sbox_y2;

	//	int loops;
	public int loopcounter;
	public int loopsleft;
	public int looptime;
	public boolean placing_loop;
	public boolean vlooped;
	public int vloopcounter;

	public int starttime;
	public boolean placing_start;
	...
	Part(int index)
	{
		...
		maxtriggers=2048;
		triggers= new Trigger [maxtriggers];//(Trigger*)malloc(maxtriggers*sizeof(Trigger));
		numtriggers=0;
		curtrigger=0;
		playing=false;
//		loops=1;
...
//		iconify=false;
	...
	boolean strfit(char[] pattern, char[] string)
	{
		int i=-1;
		while(pattern[++i]!='\0')
