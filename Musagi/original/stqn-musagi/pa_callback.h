static int pa_callback(const void *inputBuffer, void *outputBuffer,
			unsigned long framesPerBuffer, const PaStreamCallbackTimeInfo *outTime, PaStreamCallbackFlags flags, void *userData)
{
...
*/
	...
	if((int)framesPerBuffer!=buffer->size)
	{
...
//			LogPrint("callback: p4");
		...
		if(as->blipcount>0)
		{
			...
			float metvol=2.0f*gConfig.metronome_vol;
