...
public class ChemClockWidgetProvider extends AppWidgetProvider
{

	public ChemClockWidgetProvider()
	{
		// Nothing here.
	}
	...
	public void onDeleted(Context context, int[] appWidgetIds)
	{
		...
		{
			((ChemClockWidgetApp) context.getApplicationContext()).DeleteWidget(x);
		}
