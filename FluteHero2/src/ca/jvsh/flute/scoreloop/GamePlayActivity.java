...
public class GamePlayActivity extends Activity
{
	...
	public void onPause()
	{
		...
		Editor prefsEditor = getSharedPreferences(FluteHeroApplication.GAME_STATE_PREFERENCES, MODE_PRIVATE).edit();
			...
			public void onClick(View v)
			{
						...
						else
						{
							if (challenge.isComplete())
							{
								...
								if (me.equals(challenge.getWinner()))
								{
									...
									dialogSuccessMessage = getString(R.string.challenge_won, other.getDisplayName(), ScoreFormatter.format(challenge.getContenderScore()), MoneyFormatter.format(challenge.getPrize()));
								}
								else
								{
									// oh no, the user lost the challenge!
									dialogSuccessMessage = getString(R.string.challenge_lost, other.getDisplayName(), ScoreFormatter.format(challenge.getContenderScore()));
								}
							}
							else
							{
				...
				RequestControllerObserver achievementsControllerObserver = new RequestControllerObserver()
				{
					...
					public void requestControllerDidReceiveResponse(RequestController controller)
					{
						...
						{
							Achievement thousandPointsAchievement = achievementsController.getAchievementForAwardIdentifier(FluteHeroApplication.AWARD_THOUSANDPOINTS);
						...
						Achievement tenTimesAchievement = achievementsController.getAchievementForAwardIdentifier(FluteHeroApplication.AWARD_TENTIMES);
	...
	protected Dialog onCreateDialog(int id)
	{
		switch (id)
		{
			case DIALOG_PROGRESS:
				return ProgressDialog.show(GamePlayActivity.this, "", getString(R.string.submitting_your_score));
			case DIALOG_SUCCESS:
				return (new AlertDialog.Builder(this)).setMessage("").setTitle(R.string.scoreloop).setIcon(getResources().getDrawable(R.drawable.sl_icon_badge)).setPositiveButton(R.string.awesome, null).create();
			case DIALOG_FAILED:
