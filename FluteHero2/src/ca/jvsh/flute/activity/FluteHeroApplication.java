...
public class FluteHeroApplication extends Application
{
	...
	public void onCreate()
	{
		...
		final String secret = "ZdSqZm4uzz".concat("T8Fqr6V8FbjLQ").concat("JoEm7VTJ4").concat("mcKVLgN1g9tdHDreP").concat("twzhw==");
