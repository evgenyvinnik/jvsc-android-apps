...
public class HelpActivity extends Activity
{
	 ...
	 * help text.
	 */
	private final class HelpView extends LinearLayout
	{
		...
		private HelpView(int level, int titlesId, int textsId)
		{
			...
			for (int t = 0; t < nTitles; ++t)
			{
				...
				if (title.type != text.type)
					throw new IllegalArgumentException("HelpActivity:" + " titles and contents values" + " must be the same type (item " + t + ")");
				switch (title.type)
				{
					...
					case TypedValue.TYPE_REFERENCE:
						...
						break;
					default:
						throw new IllegalArgumentException("HelpActivity:" + " invalid item type (item " + t + ")");
				}
			}
	 ...
	 */
	private static final class TitleView extends LinearLayout implements View.OnClickListener
	{
	...
	private static final int[]	LEVEL_COLS	= { 0xff008c8c, 0xff8c8c00, 0xff8c008c };
