...
public class CharFormatter
{
	 ...
	 */
	private static final void formatInt(char[] buf, int off, int val, int field, char schar, boolean leadZero) throws IllegalArgumentException, OverflowException
	{
	 ...
	 *                      formatted into the field.
	 */
	private static final void formatIntLeft(char[] buf, int off, int val, int field, char schar) throws IllegalArgumentException, OverflowException
	{
